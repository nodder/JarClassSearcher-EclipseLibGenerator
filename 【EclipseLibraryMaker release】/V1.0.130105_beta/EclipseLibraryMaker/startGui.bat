...
:Set_Title
title Eclipse Library Generator %VERSION%
...
:Start_Java
%runProcess% %JAVA_OPTS% -Xms100m -Xmx250m  name.cdd.product.clzsearch.userlibmaker.gui.StartGui
